               ...
               OPTIONSPL=$(whiptail --title "云崽bot插件安装--空格选择" --checklist \
                    ...
                    do
                        case $opt in
                            ...
                            \"5\")
                               cd ${YunzaiLJ}
                               wjjpd ./plugins/earth-k-plugin
                               zxpd git clone --depth=1 https://"${installfor}"/SmallK111407/earth-k-plugin.git &
                               jdt 土块插件
                               zxpd pnpm install --filter=earth-k-plugin
                               jdt 星穹铁道插件依赖
                               installapt ffmpeg
                               ;;
                        esac
               ...
               OPTIONSPL=$(whiptail --title "云崽bot插件安装--空格选择" --checklist \
                    ...
                    do
                        case $opt in
                            ...
                            \"4\")
                               cd ${YunzaiLJ}
                               zxpd rm -rfv ./plugins/earth-k-plugin &
                               jdt 移除土块插件
                               ;;
                        esac
                    done
